...
var $author$project$Main$defaultModel = {mdc: $author$project$Material$defaultModel};
		...
		while (true) {
			switch (msg.$) {
				...
				case 'KeyDown':
					...
					return (isEscape || (isSpace || (isEnter || isArrowDown))) ? _Utils_Tuple2(
						$elm$core$Maybe$Nothing,
						A2(
							$author$project$Internal$Helpers$delayedCmd,
							16,
...
var $author$project$Internal$Slider$Model$defaultModel = {active: false, activeValue: $elm$core$Maybe$Nothing, focus: false, inTransit: false, initialized: false, left: 0, max: 100, min: 0, preventFocus: false, step: 1, width: 0};
...
var $author$project$Internal$Slider$Model$GotElement = function (a) {
	return {$: 'GotElement', a: a};
};
var $author$project$Internal$Slider$Model$GotSliderDimensions = F3(
	function (a, b, c) {
		return {$: 'GotSliderDimensions', a: a, b: b, c: c};
	});
var $author$project$Internal$Slider$Model$Init = F4(
	function (a, b, c, d) {
		return {$: 'Init', a: a, b: b, c: c, d: d};
	});
var $author$project$Internal$Slider$Model$NoOp = {$: 'NoOp'};
var $author$project$Internal$Slider$Implementation$getElement = F3(
	function (lift, id_, msg) {
		return A2(
			$elm$core$Task$attempt,
			function (result) {
				if (result.$ === 'Ok') {
					...
					return lift($author$project$Internal$Slider$Model$NoOp);
				}
			},
			$elm$browser$Browser$Dom$getElement(id_));
	});
var $author$project$Internal$Slider$Implementation$valueFromClientX = F3(
	function (config, rect, clientX) {
		var xPos = clientX - rect.left;
		var isRtl = false;
		var pctComplete = isRtl ? (1 - (xPos / rect.width)) : (xPos / rect.width);
		return config.min + (pctComplete * (config.max - config.min));
	});
			...
			switch (msg.$) {
				...
				case 'RequestSliderDimensions':
					...
					return _Utils_Tuple2(
						$elm$core$Maybe$Nothing,
						A3(
							$author$project$Internal$Slider$Implementation$getElement,
							lift,
							id_,
							A2($author$project$Internal$Slider$Model$GotSliderDimensions, next, clientX)));
				case 'GotSliderDimensions':
					var next = msg.a;
					var clientX = msg.b;
					var el = msg.c;
					var new_model = _Utils_update(
						model,
						{left: el.element.x, width: el.element.width});
					var $temp$lift = lift,
						$temp$msg = next(clientX),
				...
				case 'InteractionStart':
					var clientX = msg.a;
					var activeValue = A3($author$project$Internal$Slider$Implementation$valueFromClientX, model, model, clientX);
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
				...
				case 'Init':
					...
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{initialized: true, max: max_, min: min_, step: step_})),
						A3($author$project$Internal$Slider$Implementation$getElement, lift, id_, $author$project$Internal$Slider$Model$GotElement));
				case 'Resize':
					var id_ = msg.a;
					var min_ = msg.b;
					var max_ = msg.c;
					var step_ = msg.d;
					var $temp$lift = lift,
						$temp$msg = A4($author$project$Internal$Slider$Model$Init, id_, min_, max_, step_),
						$temp$model = model;
					lift = $temp$lift;
					msg = $temp$msg;
					model = $temp$model;
				...
				case 'Up':
					return _Utils_Tuple2(
						...
						A2(
							$author$project$Internal$Helpers$delayedCmd,
							50,
							lift($author$project$Internal$Slider$Model$ActualUp)));
				default:
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
...
var $author$project$Internal$TabBar$Model$defaultModel = {activeTab: 0, animating: false, focusedTab: $elm$core$Maybe$Nothing, geometry: $elm$core$Maybe$Nothing, ripples: $elm$core$Dict$empty, scrollDelta: 0, startAnimating: false};
...
var $author$project$Internal$TabBar$Model$AnimationStart = {$: 'AnimationStart'};
var $author$project$Internal$TabBar$Model$FocusTab = F2(
	function (a, b) {
		return {$: 'FocusTab', a: a, b: b};
	});
...
var $author$project$Internal$TabBar$Implementation$tabId = F2(
	function (domId, index) {
		return domId + ('--button-' + $elm$core$String$fromInt(index));
	});
		...
		while (true) {
			switch (msg.$) {
				...
				case 'AnimationStart':
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{animating: true, scrollDelta: 0, startAnimating: false})),
						$elm$core$Platform$Cmd$none);
				case 'SetActiveTab':
					var domId = msg.a;
					var tab_index = msg.b;
					...
					var scrollContentWidth = geometry.scrollContent.offsetWidth;
					...
					var isOverflowing = _Utils_cmp(scrollContentWidth, tabBarWidth) > 0;
					...
					var newScrollPosition = (!tab_index) ? 0 : (_Utils_eq(
						tab_index,
						$elm$core$List$length(geometry.tabs) - 1) ? (scrollContentWidth - tabBarWidth) : (scrollPosition + scrollIncrement));
					var scrollDelta = scrollPosition - newScrollPosition;
					var _v2 = isOverflowing ? _Utils_Tuple2(true, $author$project$Internal$TabBar$Model$AnimationStart) : _Utils_Tuple2(false, $author$project$Internal$TabBar$Model$NoOp);
					var animate = _v2.a;
					var m = _v2.b;
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{activeTab: tab_index, animating: false, focusedTab: $elm$core$Maybe$Nothing, scrollDelta: scrollDelta, startAnimating: animate})),
						A2(
							$elm$core$Task$perform,
							lift,
							A2(
				...
				case 'FocusTab':
					...
					return _Utils_Tuple2(
						...
						A2(
							$elm$core$Task$attempt,
							function (_v5) {
								return lift($author$project$Internal$TabBar$Model$NoOp);
							},
							$elm$browser$Browser$Dom$focus(
								A2($author$project$Internal$TabBar$Implementation$tabId, domId, index))));
				case 'ResetFocusedTab':
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{focusedTab: $elm$core$Maybe$Nothing})),
						$elm$core$Platform$Cmd$none);
				case 'Left':
					var domId = msg.a;
					var tab_index = msg.b;
					var focusedTab = function () {
						var _v6 = model.focusedTab;
						if (_v6.$ === 'Just') {
							var index = _v6.a;
							return index - 1;
						} else {
					...
					if (focusedTab >= 0) {
						var $temp$lift = lift,
							$temp$msg = A2($author$project$Internal$TabBar$Model$FocusTab, domId, focusedTab),
							$temp$model = _Utils_update(
							model,
							{
								focusedTab: $elm$core$Maybe$Just(focusedTab)
							});
						lift = $temp$lift;
						msg = $temp$msg;
						model = $temp$model;
				...
				case 'Right':
					...
					var tab_index = msg.b;
					var geometry = A2($elm$core$Maybe$withDefault, $author$project$Internal$TabBar$Model$defaultGeometry, model.geometry);
					var max_tabs = $elm$core$List$length(geometry.tabs);
					var focusedTab = function () {
						var _v7 = model.focusedTab;
						if (_v7.$ === 'Just') {
							var index = _v7.a;
							return index + 1;
						} else {
					...
					if (_Utils_cmp(focusedTab, max_tabs) < 0) {
						var $temp$lift = lift,
							$temp$msg = A2($author$project$Internal$TabBar$Model$FocusTab, domId, focusedTab),
							$temp$model = _Utils_update(
							model,
...
var $author$project$Internal$TextField$Implementation$email = $author$project$Internal$Options$option(
	function (config) {
		return _Utils_update(
			config,
			{
				type_: $elm$core$Maybe$Just('email')
			});
	});
...
var $author$project$Internal$TextField$Implementation$password = $author$project$Internal$Options$option(
	function (config) {
		return _Utils_update(
			config,
			{
				type_: $elm$core$Maybe$Just('password')
			});
	});
...
var $author$project$Internal$Elevation$Implementation$transition = $author$project$Internal$Options$cs('mdc-elevation-transition');
var $author$project$Material$Elevation$transition = $author$project$Internal$Elevation$Implementation$transition;
...
var $author$project$Internal$Ripple$Implementation$decodeClientRect = $K_Adam$elm_dom$DOM$target(
	A5($elm$json$Json$Decode$map4, $author$project$Internal$Ripple$Model$ClientRect, $K_Adam$elm_dom$DOM$offsetTop, $K_Adam$elm_dom$DOM$offsetLeft, $K_Adam$elm_dom$DOM$offsetWidth, $K_Adam$elm_dom$DOM$offsetHeight));
...
var $author$project$Internal$TextField$Implementation$blockName = 'mdc-text-field';
var $author$project$Internal$TextField$Implementation$block = $author$project$Internal$Options$cs($author$project$Internal$TextField$Implementation$blockName);
...
var $K_Adam$elm_dom$DOM$childNode = function (idx) {
...
var $author$project$Internal$TextField$Implementation$decodeGeometry = $K_Adam$elm_dom$DOM$target(
	$K_Adam$elm_dom$DOM$parentElement(
		A4(
			$elm$json$Json$Decode$map3,
			$author$project$Internal$TextField$Model$Geometry,
			A2($K_Adam$elm_dom$DOM$childNode, 2, $K_Adam$elm_dom$DOM$offsetWidth),
			A2($K_Adam$elm_dom$DOM$childNode, 2, $K_Adam$elm_dom$DOM$offsetHeight),
			A2($K_Adam$elm_dom$DOM$childNode, 1, $K_Adam$elm_dom$DOM$offsetWidth))));
...
var $author$project$Internal$TextField$Implementation$element = function (module_) {
	return $author$project$Internal$Options$cs($author$project$Internal$TextField$Implementation$blockName + ('__' + module_));
};
...
var $author$project$Internal$TextField$Implementation$iconView = F4(
	function (lift, icon, iconClass, handler) {
		if (icon.$ === 'Just') {
			var name = icon.a;
			return A3(
				$author$project$Internal$Options$styled,
				...
				_List_fromArray(
					[
						$author$project$Internal$Options$cs('material-icons mdc-text-field__icon mdc-text-field__icon--' + iconClass),
						A2(
						$author$project$Internal$Options$when,
...
var $author$project$Internal$TextField$Implementation$modifier = function (modifier_) {
	return $author$project$Internal$Options$cs($author$project$Internal$TextField$Implementation$blockName + ('--' + modifier_));
};
...
var $author$project$Internal$Options$viewJust = F2(
	function (value, view) {
		if (value.$ === 'Just') {
			var a = value.a;
			return view(a);
...
var $author$project$Internal$TextField$Implementation$textField = F5(
	function (domId, lift, model, options, list) {
		var viewSuffix = function (s) {
			return A3(
				$author$project$Internal$Options$styled,
				$elm$html$Html$span,
				_List_fromArray(
					[
						$author$project$Internal$TextField$Implementation$element('affix'),
						$author$project$Internal$TextField$Implementation$element('affix--suffix')
					]),
				_List_fromArray(
					[
		...
		var viewPrefix = function (s) {
			return A3(
				...
				_List_fromArray(
					[
						$author$project$Internal$TextField$Implementation$element('affix'),
						$author$project$Internal$TextField$Implementation$element('affix--prefix')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(s)
		...
		var config = summary.config;
		var canHaveLabel = !(config.fullWidth || (config.outlined || config.textarea));
		var focused = model.focused && (!config.disabled);
		var hasLabel = !_Utils_eq(config.labelText, $elm$core$Maybe$Nothing);
		var isDirty = model.isDirty || A2(
			...
			A2(
				...
				$elm$core$Basics$neq(''),
				config.value));
		var isFilled = !config.outlined;
		var isInvalid = config.invalid || function () {
			var _v2 = config.pattern;
			if (_v2.$ === 'Just') {
				var pattern_ = _v2.a;
				return A2(
					$elm$core$Maybe$withDefault,
		...
		var isOutlined = config.outlined;
		var leadingIcon_ = A4($author$project$Internal$TextField$Implementation$iconView, lift, config.leadingIcon, 'leading', config.onLeadingIconClick);
		var shouldAlwaysFloat = function () {
			var _v1 = config.type_;
			if (_v1.$ === 'Just') {
				var t = _v1.a;
				return (t === 'color') || ((t === 'date') || ((t === 'datetime-local') || ((t === 'month') || ((t === 'range') || ((t === 'time') || (t === 'week'))))));
			} else {
				return false;
			}
		}();
		var shouldFloat = shouldAlwaysFloat || (focused || isDirty);
		var htmlLabel = A3(
			$author$project$Internal$Options$styled,
			$elm$html$Html$label,
			_List_fromArray(
				[
					...
					$author$project$Internal$Options$when,
					config.required,
					$author$project$Internal$Options$cs('mdc-floating-label--required')),
					$author$project$Internal$Options$for(config.id_)
				]),
			function () {
				var _v0 = config.labelText;
				if (_v0.$ === 'Just') {
					var str = _v0.a;
					return _List_fromArray(
						[
		...
		var trailingIcon_ = A4($author$project$Internal$TextField$Implementation$iconView, lift, config.trailingIcon, 'trailing', config.onTrailingIconClick);
		var input = A4(
		...
		return A5(
			...
			_List_fromArray(
				[
					$author$project$Internal$TextField$Implementation$block,
					A2(
					$author$project$Internal$Options$when,
					focused,
					$author$project$Internal$TextField$Implementation$modifier('focused')),
					A2(
					$author$project$Internal$Options$when,
					shouldFloat,
					$author$project$Internal$TextField$Implementation$modifier('label-floating')),
					A2(
					$author$project$Internal$Options$when,
					canHaveLabel && (!hasLabel),
					$author$project$Internal$TextField$Implementation$modifier('no-label')),
					A2(
					$author$project$Internal$Options$when,
					config.disabled,
					$author$project$Internal$TextField$Implementation$modifier('disabled')),
					A2(
					$author$project$Internal$Options$when,
					config.fullWidth,
					$author$project$Internal$TextField$Implementation$modifier('fullwidth')),
					A2(
					$author$project$Internal$Options$when,
					isInvalid,
					$author$project$Internal$TextField$Implementation$modifier('invalid')),
					A2(
					$author$project$Internal$Options$when,
					isFilled,
					$author$project$Internal$TextField$Implementation$modifier('filled')),
					A2(
					$author$project$Internal$Options$when,
					isOutlined,
					$author$project$Internal$TextField$Implementation$modifier('outlined')),
					A2(
					$author$project$Internal$Options$when,
					!_Utils_eq(config.leadingIcon, $elm$core$Maybe$Nothing),
					$author$project$Internal$TextField$Implementation$modifier('with-leading-icon')),
					A2(
					$author$project$Internal$Options$when,
					!_Utils_eq(config.trailingIcon, $elm$core$Maybe$Nothing),
					$author$project$Internal$TextField$Implementation$modifier('with-trailing-icon')),
					A2(
					$author$project$Internal$Options$when,
					config.textarea,
					$author$project$Internal$TextField$Implementation$modifier('textarea'))
				]),
			_List_Nil,
			_Utils_ap(
				list,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Internal$TextField$Implementation$element('ripple')
							]),
						_List_Nil) : $elm$html$Html$text(''),
						leadingIcon_,
						(!config.textarea) ? A2($author$project$Internal$Options$viewJust, config.prefix, viewPrefix) : $elm$html$Html$text(''),
						input,
						(!config.textarea) ? A2($author$project$Internal$Options$viewJust, config.suffix, viewSuffix) : $elm$html$Html$text(''),
						(hasLabel && canHaveLabel) ? htmlLabel : $elm$html$Html$text(''),
						trailingIcon_,
...
var $author$project$Main$form = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				$author$project$Material$Elevation$transition,
				A2($author$project$Material$Options$css, 'display', 'flex'),
				A2($author$project$Material$Options$css, 'justify-content', 'space-evenly'),
				A2($author$project$Material$Options$css, 'flex-direction', 'column'),
				A2($author$project$Material$Options$css, 'height', 'auto'),
				A2($author$project$Material$Options$css, 'padding', '8%'),
				A2($author$project$Material$Options$css, 'margin', 'auto')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Material$TextField$label('email'),
								$author$project$Material$TextField$email
							]),
						_List_Nil),
						A5(
						$author$project$Material$TextField$view,
						...
						_List_fromArray(
							[
								$author$project$Material$TextField$label('password'),
								$author$project$Material$TextField$password
							]),
						_List_Nil),
						A5(
						...
						_List_fromArray(
							[
								...
								$author$project$Material$Options$onClick($author$project$Main$HandleSubmit),
								A2($author$project$Material$Options$css, 'height', '20%')
							]),
						_List_fromArray(
							[
